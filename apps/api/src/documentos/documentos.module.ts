 ...
 * emitido; cálculo en vivo y ciclo de borrador; PDF de factura. Importa CumplimientoModule (P17) para
 * registrar el evento fiscal y encolar la remisión en la misma transacción de emisión.
 * `DatabaseService` y `AuditService` llegan por los módulos globales.
 */
@Module({
  imports: [CumplimientoModule],
